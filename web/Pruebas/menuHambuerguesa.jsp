<%-- 
    Document   : menuHambuerguesa
    Created on : 08-ago-2017, 13:40:33
...
.button:hover:before {
  -webkit-transform: translateY(0);
    ...
    <body>
       <h1>  Click on the hamburger icon ?</h1>
       <div  class="open">    
           <span class="cls"></span>    
           <span>        
               <ul class="sub-menu ">            
                   ...
                   <li>       
                    ...
                    <li>       
                       <a href="#contact" title="Amenaza">Amenaza / Warring</a>      
                   </li>  
                    <li>       
                       <a href="#contact" title="contact">Contato / Contact</a>      
                   </li>  
