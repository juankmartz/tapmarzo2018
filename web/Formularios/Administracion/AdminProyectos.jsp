...
<!--
    ...
    <div class="container-fluid center-block ">
        <div class="x_panel_Principal ">
            <div class="x_panel ">
                <div class="x_title">
                    <a href="#1" class="collapse-link cerrar" > 
...
%>
                        <div class="col-xs-12 col-sm-6 x_panel_Principal" >
                            <div class="x_panel " style="height: auto;">
                                <div class="x_title">
                                    ...
                                    <!--<ul class="nav navbar-right panel_toolbox"> <i class="faa faa-chevron-up"></i>-->
                                    <ul class="ul-simple">
                                        <li><a href="#1" class="collapse-link cerrar" > <h2 class="text-uppercase text-info " style="width: 90%;"><%=proyect.getTitulo()%> <br> <span class="h5 text-lowercase"><%=proyect.getResumen()%></span></h2></a></li>
                                ...
                                <div class="x_content form-horizontal collapsed"> 
                                    <div class="col-xs-12 ">
                                        <h5 class="" style="font-weight: bold">Especies de estudio</h5>
                                        <%
                                            if (especiesProyect.size() == 0) {
                                        %> <i class="" style="padding-left: 10px;"> Sin definir especies en este proyecto</i><%
                                            }
                                        %>
                                        <ul style="padding-left: 10px;">
                                            <%                    for (taxonomia especie : especiesProyect) {
                                            %>
                                            <li><%=especie.getEspecie()%> (<i class=""><%=especie.getNombreComun()%></i>)</li>
                                                <%
                                                    }
                                                %>
                                        </ul>
                                    ...
                                    <div class="col-xs-12 ">
                                        <h5 class="" style="font-weight: bold">Localidades de estudio</h5>
                                        <%
                                            if (localidadProyect.size() == 0) {
                                        %> <i class="" style="padding-left: 10px;"> Sin definir Localidades a este proyecto</i><%
                                            }
                                        %>
                                        <ul style="padding-left: 10px;">
                                            <%
                                            ...
                                            %>
                                            <li><%=locald.getNombre()%> (<i class=""><%=locald.getLat()%>, <%=locald.getLon()%></i>)</li>
                                                <%
                                                    }
                                                %>
                                        </ul>
                                    ...
                                    <div class="col-xs-12">
                                        <h5 class="" style="font-weight: bold">Rasgos de estudio</h5>
                                        <%
                                            if (rasgosProyect.size() == 0) {
                                        %> <i class="" style="padding-left: 10px;"> Sin rasgos de interes en este proyecto</i><%
                                            }
                                        %>
                                        <ul style="padding-left: 10px;">
                                            <%
                                            ...
                                            %>
                                            <li><%=rasgop.getNombre()%> (<i class=""><%=rasgop.getUnidad()%></i>)</li>
                                                <%
                                                    }
                                                %>
                                        </ul>
